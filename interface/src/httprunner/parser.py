...
from src.httprunner import exceptions, utils, validator
from src.httprunner.compat import basestring, builtin_str, numeric_types, str
...
def get_mapping_function(function_name, functions_mapping):
    ...
    try:
        ...
        from src.httprunner import loader
