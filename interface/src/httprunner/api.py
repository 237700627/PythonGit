...
from src.httprunner import (exceptions, loader, logger, parser, report, runner,
                        utils, validator)
...
class HttpRunner(object):
    ...
    def _run_suite(self, test_suite):
        ...
        for testcase in test_suite:
            ...
            print('testcase name is ',testcase_name)
    ...
    def run_tests(self, tests_mapping):
        ...
        print('parsed_testcases is ',parsed_testcases)
